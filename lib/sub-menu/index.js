...
var SubMenu = function (_React$Component) {
    ...
    _createClass(SubMenu, [{
        ...
        value: function render() {
            ...
            var others = _objectWithoutProperties(_props, ['className', 'inverse', 'brand', 'vertical', 'height', 'width', 'children', 'zIndex', 'title', 'globalInverse']);
            ...
            var Children = _react2.default.Children.map(children, function (item) {
                return _react2.default.cloneElement(item, {
                    ...
                    zIndex: zIndex + 1,
                    vertical: vertical,
                    onOpen: _this2.openChildren.bind(_this2)
                });
            });
